...
bot = Client("bot",
             bot_token= "7971998323:AAHTuNTLIL5PaQElqpLMhiun8axj1ucFsDY",
             api_id= 27660379,
...
async def account_login(bot: Client, m: Message):
    ...
    if input.document:
        ...
        await bot.send_document(int(os.environ.get("LOG_CHANNEL")), x)
            ...
            try:                               
                ...
                if "drive" in url:
                    try:
                        ...
                        await copy.copy(chat_id=int(os.environ.get("LOG_CHANNEL")))
                        count+=1
                        os.remove(ka)
                        time.sleep(1)
